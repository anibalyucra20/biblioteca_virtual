...
if (!verificar_sesion($conexion) == 1) {
    ...
    $id_pe = $r_b_usuario['id_programa_estudio'];
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <a href="asignacion_masiva.php" target="_blank" rel="noopener noreferrer" class="btn btn-success">Asignación masiva</a>
                                        <br>
                                        <table id="example" class="table dt-responsive " width="100%">
                                            ...
                                            <tbody>
                                                <?php
                                                //$b_libros = buscar_libroByIdPE($conexion, $id_pe);
