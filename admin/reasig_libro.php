                            ...
                            <div class="col-xl-12 col-md-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <form role="form" action="operaciones/reasignar_libro.php" method="POST" enctype="multipart/form-data">
                                            ...
                                            <div class="form-row">
                                                ...
                                                <div class="col-md-12 mb-3">
                                                    ...
                                                    <input type="text" class="form-control" name="titulo" required value="<?php echo $r_b_libro['titulo']; ?>" readonly>
                                                </div>
                                                <div class="col-md-12 mb-3">
                                                    <label for="validationCustom02">Autor :</label>
                                                    <input type="text" class="form-control" name="autor" required value="<?php echo $r_b_libro['autor']; ?>" readonly>
                                                </div>
                                                <div class="col-md-12 mb-3">
                                                    <label for="validationCustom02">Editorial :</label>
                                                    <input type="text" class="form-control" name="editorial" required value="<?php echo $r_b_libro['editorial']; ?>" readonly>
                                                </div>
                                                <div class="col-md-6 mb-3">
                                                    <label for="validationCustom02">Año de Edicion :</label>
                                                    <input type="text" class="form-control" name="edicion" value="<?php echo $r_b_libro['edicion']; ?>" readonly>
                                                </div>
                                                <div class="col-md-6 mb-3">
                                                    <label for="validationCustom02">Tomo :</label>
                                                    <input type="text" class="form-control" name="tomo" value="<?php echo $r_b_libro['tomo']; ?>" readonly>
                                                </div>
                                                <div class="col-md-12 mb-3">
